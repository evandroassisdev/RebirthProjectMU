...
void CheckChatText(char* Text)
{
	...
	if (FindText(Text, "Greatings") || FindText(Text, "greatings") || FindText(Text, "Hi") || FindText(Text, "hi")
		...
		// Portug�s
		|| FindText(Text, "Ol�") || FindText(Text, "ol�") || FindText(Text, "Ola") || FindText(Text, "ola") || FindText(Text, "Oi") || FindText(Text, "oi"))
	{
	...
	// English
		...
		// Spanish
		|| FindText(Text, "Adi�s") || FindText(Text, "adi�s")
		// Portug�s
		|| FindText(Text, "Adeus") || FindText(Text, "adeus") || FindText(Text, "Tchau") || FindText(Text, "tchau") || FindText(Text, "At�") || FindText(Text, "at�"))
	{
	...
	// English
		...
		// Portug�s
		|| FindText(Text, "Aplausos") || FindText(Text, "aplausos") || FindText(Text, "Palmas") || FindText(Text, "Palmas") || FindText(Text, "Parab�ns") || FindText(Text, "parab�ns") || FindText(Text, "Parabens") || FindText(Text, "parabens"))
	{
	...
	// English
		...
		// Spanish
		|| FindText(Text, "Aqu�") || FindText(Text, "aqu�")
		// Portug�s
	...
	// English
		...
		// Spanish
		|| FindText(Text, "Ah�") || FindText(Text, "ah�") || FindText(Text, "All�") || FindText(Text, "All�") || FindText(Text, "Ahi") || FindText(Text, "ahi") || FindText(Text, "Alli") || FindText(Text, "Alli")
		// Portugu�s
		|| FindText(Text, "Ali") || FindText(Text, "ali") || FindText(Text, "L�") || FindText(Text, "l�") || FindText(Text, "La") || FindText(Text, "la"))
	{
	...
	// English
		...
		// Portugu�s
		|| FindText(Text, "N�o") || FindText(Text, "n�o") || FindText(Text, "Nao") || FindText(Text, "nao"))
	{
	...
	// English
		...
		// Spanish
		|| FindText(Text, "Mala") || FindText(Text, "mala") || FindText(Text, "Perd�n") || FindText(Text, "Perdon") || FindText(Text, "perdon")
		// Portugu�s
	...
	// English
		...
		// Portugu�s
		|| FindText(Text, "Perdemos") || FindText(Text, "perdemos") || FindText(Text, "perdemos...") || FindText(Text, "Perdemos...") || FindText(Text, "N�oo") || FindText(Text, "n�oo") || FindText(Text, "Aaa") || FindText(Text, "aaa")
		// Simbols
	...
	// English
		...
		// Spanish
		|| FindText(Text, "Gan�") || FindText(Text, "gan�") || FindText(Text, "Gane") || FindText(Text, "gane")
		// Portug�s
	...
	// English
		...
		// Portug�s
		|| FindText(Text, "Sauda��es") || FindText(Text, "sauda��es") || FindText(Text, "Senhor") || FindText(Text, "senhor"))
	{
	...
	// English
		...
		// Spanish
		|| FindText(Text, "Provocaci�n") || FindText(Text, "provocaci�n") || FindText(Text, "Provocacion") || FindText(Text, "provocacion") || FindText(Text, "provocacion") || FindText(Text, "provocacion")
		// Portug�s
		|| FindText(Text, "Provoca��o") || FindText(Text, "provoca��o") || FindText(Text, "Provocacao") || FindText(Text, "provocacao") || FindText(Text, "Vem") || FindText(Text, "vem"))
	{
		...
		// Spanish
		|| FindText(Text, "Campe�n") || FindText(Text, "campe�n") || FindText(Text, "Campeon") || FindText(Text, "campeon")
		// Portug�s
		|| FindText(Text, "Campe�o") || FindText(Text, "campe�o") || FindText(Text, "Campeao") || FindText(Text, "campeao"))
	{
