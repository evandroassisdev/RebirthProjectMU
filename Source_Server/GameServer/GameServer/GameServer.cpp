		...
		case WM_TIMER:
			switch(wParam)
			{
				...
				case WM_TIMER_2000:
					...
					// ANCHOR_STATUSBAR_REFRESH_FIX_START: status bar was only ever
					// filled once in WM_CREATE (before gServerInfo was even loaded),
					// so "Connected"/"Monsters" stayed frozen at 0/0 forever. Refresh
					// it here on the same 2s tick that recomputes the obj counters.
					...
					// ANCHOR_STATUSBAR_REFRESH_FIX_END
					break;
				case WM_TIMER_10000:
